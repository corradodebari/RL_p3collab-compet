...
3. Clone the repository **"corradodebari/RL_p3collab-compet"** from GitHub (NOTE: install git client before or, alternatively, download as zip file)
  
```
#git clone https://github.com/corradodebari/RL_p3collab-compet.git  
```
...
Unzip and copy under directory:  RL_p3collab-compet
